...
<body class="background-material">
    <div id="main-container">
        <div id="Splash-pic">
            <div id="hidden">
                <ul>
                    <li><a class="logo" href="index.php"><img src="img/logo.png" height="21px" />&nbsp;<strong>PharmEasy</strong></a></li>
            ...
            <div class="footer" style="margin: 0; background-color: #383838; color: #ccc; padding: 10px 0px; float: left; width: 100%;">
                <div class="container text-center"> 
                    <p id="foot" style="margin:0px;">Designed By : Prem Sachade</p>
                </div>
            </div>
        </div>
    </div>
