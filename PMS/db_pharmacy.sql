...
--
-- Host: localhost
-- Generation Time: May 04, 2020 at 05:52 PM
...
(1001, 'premsachade', '0cef1fb10f60529028a71f58e54ed07b', 'Prem', 'Sachade', '9722068224', 'premsachade@gmail.com', 1, 1001);
...
CREATE TABLE `tbl_invoice_item` (
  `invitem_id` int UNSIGNED NOT NULL,
...
CREATE TABLE `tbl_order` (
  ...
  `ordtype_id` int NOT NULL DEFAULT '0',
  `client_id` int NOT NULL DEFAULT '0',
  `date_modified` date NOT NULL DEFAULT '0000-00-00',
  `time_modified` time NOT NULL DEFAULT '00:00:00',
...
CREATE TABLE `tbl_orditem` (
  `orditem_id` int UNSIGNED NOT NULL,
  `order_id` int NOT NULL DEFAULT '0',
  `pro_id` int NOT NULL DEFAULT '0',
  `lot_id` int NOT NULL DEFAULT '0',
  `qty_total` int NOT NULL DEFAULT '0',
  `qty_delivery` int NOT NULL DEFAULT '0',
...
CREATE TABLE `tbl_ordtype` (
  `ordtype_id` int UNSIGNED NOT NULL,
...
CREATE TABLE `tbl_ord_invoice` (
  `ord_invoice_id` int UNSIGNED NOT NULL,
  `order_id` int NOT NULL DEFAULT '0',
  `invoice_id` int NOT NULL DEFAULT '0',
  `usr_id` int NOT NULL DEFAULT '0'
) ENGINE=MyISAM DEFAULT CHARSET=latin1;
...
CREATE TABLE `tbl_paymode` (
  `paymode_id` int UNSIGNED NOT NULL,
...
CREATE TABLE `tbl_product` (
  ...
  `pro_reorder_level` int NOT NULL DEFAULT '0',
  `pro_total_qty` int NOT NULL DEFAULT '0',
...
CREATE TABLE `tbl_prod_supplier` (
  `p_supplier_id` int UNSIGNED NOT NULL,
  `pro_id` int NOT NULL DEFAULT '0',
...
CREATE TABLE `tbl_users` (
  ...
  `usr_stat` int NOT NULL DEFAULT '1',
...
--
ALTER TABLE `tbl_access`
  MODIFY `acc_id` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4006;
...
--
ALTER TABLE `tbl_cart`
  MODIFY `c_id` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1000132;

--
-- AUTO_INCREMENT for table `tbl_category`
--
ALTER TABLE `tbl_category`
  MODIFY `cat_id` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;

--
-- AUTO_INCREMENT for table `tbl_client`
--
ALTER TABLE `tbl_client`
  MODIFY `client_id` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1028;

--
-- AUTO_INCREMENT for table `tbl_delivery`
--
ALTER TABLE `tbl_delivery`
  MODIFY `delivery_id` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1000000101;

--
-- AUTO_INCREMENT for table `tbl_delivery_items`
--
ALTER TABLE `tbl_delivery_items`
  MODIFY `d_items_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=124;

--
-- AUTO_INCREMENT for table `tbl_disposal`
--
ALTER TABLE `tbl_disposal`
  MODIFY `disposal_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;

--
-- AUTO_INCREMENT for table `tbl_invoice`
--
ALTER TABLE `tbl_invoice`
  MODIFY `invoice_id` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2000000104;

--
-- AUTO_INCREMENT for table `tbl_invoice_item`
--
ALTER TABLE `tbl_invoice_item`
  MODIFY `invitem_id` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1000000129;

--
-- AUTO_INCREMENT for table `tbl_lot`
--
ALTER TABLE `tbl_lot`
  MODIFY `lot_id` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1000000150;

--
-- AUTO_INCREMENT for table `tbl_notifications`
--
ALTER TABLE `tbl_notifications`
  MODIFY `n_id` bigint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5000000017;

--
-- AUTO_INCREMENT for table `tbl_order`
--
ALTER TABLE `tbl_order`
  MODIFY `order_id` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1000000135;

--
-- AUTO_INCREMENT for table `tbl_orditem`
--
ALTER TABLE `tbl_orditem`
  MODIFY `orditem_id` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=176;

--
-- AUTO_INCREMENT for table `tbl_ordtype`
--
ALTER TABLE `tbl_ordtype`
  MODIFY `ordtype_id` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;

--
-- AUTO_INCREMENT for table `tbl_ord_invoice`
--
ALTER TABLE `tbl_ord_invoice`
  MODIFY `ord_invoice_id` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=400000112;

--
-- AUTO_INCREMENT for table `tbl_paymode`
--
ALTER TABLE `tbl_paymode`
  MODIFY `paymode_id` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=42;

--
-- AUTO_INCREMENT for table `tbl_payterm`
--
ALTER TABLE `tbl_payterm`
  MODIFY `term_id` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;

--
-- AUTO_INCREMENT for table `tbl_product`
--
ALTER TABLE `tbl_product`
  MODIFY `pro_id` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10126;

--
-- AUTO_INCREMENT for table `tbl_prod_supplier`
--
ALTER TABLE `tbl_prod_supplier`
  MODIFY `p_supplier_id` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1000000158;

--
-- AUTO_INCREMENT for table `tbl_users`
--
ALTER TABLE `tbl_users`
  MODIFY `usr_id` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1019;
COMMIT;
