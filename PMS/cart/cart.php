<div id="cart-container" style=>
    ...
    <div id="cart-ads-wrapper">
        ...
        <div id="cart-ads-content">
            ...
            <p>To offer you a good shopping experience, PharmEasy accepts payments through Cash and Online Payment ONLY.</p>
        </div>
        <div id="cart-ads-content">
            <h5>AM I SECURED WITH ONLINE ORDERING?</h5>
            <p>PharmEasy takes the utmost care of securing information provided to our website. We prioritize safety during the ordering 
